  ...
  return (
    ...
    >
      <div style={{ marginRight: CARD_GAP }}>
        ...
        >
          {/* Image */}
          <div className="relative overflow-hidden bg-secondary/30 flex items-center justify-center h-56 md:h-64">
            {isFlagship && (
              ...
              {project.liveUrl !== "#" && (
                <MagneticWrapper strength={0.3} maxDistance={100}>
                  <Button
                    variant="default"
                    size="sm"
                    className="gradient-bg rounded-lg flex-1 min-w-[100px] shadow-lg shadow-primary/20 hover:scale-[1.03] transition-transform font-semibold"
                    asChild
                  >
                    <a
              ...
              {project.githubUrl !== "#" && (
                <MagneticWrapper strength={0.3} maxDistance={100}>
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 min-w-[100px] rounded-lg hover:bg-secondary hover:text-foreground hover:scale-[1.03] transition-transform text-muted-foreground font-semibold"
                    asChild
                  >
                    <a
              ...
              {project.youtubeUrl && (
                <MagneticWrapper strength={0.3} maxDistance={100}>
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 min-w-[100px] rounded-lg border-red-500/50 text-red-500 hover:bg-red-500/10 hover:border-red-500 hover:text-red-500 hover:scale-[1.03] transition-transform font-semibold"
                    asChild
                  >
                    <a
